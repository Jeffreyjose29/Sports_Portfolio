...
# Titles
final_image <- image_composite(final_image, club_logo, gravity = "west", offset = "+20-820")

final_image <- image_annotate(final_image, "ARSENAL F.C DROP-OFF FROM TITLE GRASP", gravity = "west", weight = 900, size = 90, 
                              color = "#FFFFFF", location = "+270-900")
final_image <- image_annotate(final_image, "A 3-Game Running Total Of Scoring & Conceding Outputs In The English Premier League (2023/24 Season To 2024/25 Season)", gravity = "west", weight = 300, size = 50, 
...
final_image <- image_annotate(final_image, "Season 2023/24", gravity = "north", weight = 700, size = 50, 
