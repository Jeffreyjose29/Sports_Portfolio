...
primary_colour <- "#c7102e"
secondary_colour <- "#00b1a7"

image_file_location <- "C:/Users/jeffr/Downloads/New folder/"
club_logo <- image_read(
  paste0(image_file_location, "Liverpool.png")) %>%
  image_resize("300x300")

########################################################################################################################

# Liverpool 2019/2020 season
season_2019_2020 <- fb_match_results(country = "ENG", gender = "M", season_end_year = 2020, tier = "1st")
